...
public class AjouterEtudiantSportif {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AjouterEtudiantSportif window = new AjouterEtudiantSportif();
	...
	private void initialize() {
		...
		JLabel lblNewLabel_1 = new JLabel("Nouvel Etudiant Sportif");
